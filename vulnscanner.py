#!/usr/bin/python
# -*- coding: utf-8 -*-
#                               | \    /\(  ____ \(  __  \ \__   __/(  ____ )\__   __/(  ____ \(  ____ \(  ____ \\__   __/(  ____ \(  ___  )(       )
#                               |  \  / /| (    \/| (  \  )   ) (   | (    )|   ) (   | (    \/| (    \/| (    \/   ) (   | (    \/| (   ) || () () |
#                               |  (_/ / | (__    | |   ) |   | |   | (____)|   | |   | (_____ | (__    | |         | |   | (__    | (___) || || || |
#                               |   _ (  |  __)   | |   | |   | |   |     __)   | |   (_____  )|  __)   | |         | |   |  __)   |  ___  || |(_)| |
#                               |  ( \ \ | (      | |   ) |   | |   | (\ (      | |         ) || (      | |         | |   | (      | (   ) || |   | |
#                               |  /  \ \| (____/\| (__/  )___) (___| ) \ \_____) (___/\____) || (____/\| (____/\   | |   | (____/\| )   ( || )   ( |
#                               |_/    \/(_______/(______/ \_______/|/   \__/\_______/\_______)(_______/(_______/   )_(   (_______/|/     \||/     \|
#                                                                                                                    
#                              
#                            
#                                 
...
# Author	 :Rditya1337
# Tool 		 : vulnscanner
# Usage		 : ./vulnscanner.py example.com (or) python vulnscanner.py example.com
...
# vulnscanner Help Context
def helper():
        print bcolors.OKBLUE+"Information:"+bcolors.ENDC
        print "------------"
        print "\t./vulnscanner.py example.com: Scans the domain example.com."
        print "\t./vulnscanner.py example.com --skip dmitry --skip theHarvester: Scans the domain example.com, but skip the 'dmitry' and 'theHarvester' tests."
        print "\t./vulnscanner.py --update   : Updates the scanner to the latest version."
        print "\t./vulnscanner.py --help     : Displays this help context."
